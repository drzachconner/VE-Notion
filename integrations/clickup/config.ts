...
import { LeadTier } from '../../core/types/lead';
 ...
 */
export function validateClickUpStructure(): { valid: boolean; missing: string[] } {
  ...
  if (!lists.tier1Low) missing.push('CLICKUP_TIER1_LOW_ID');
